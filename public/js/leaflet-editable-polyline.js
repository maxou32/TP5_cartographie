    ...
    _addMethods: function() {
        ...
        this._parseOptions = function(options) {
            ...
            if(!options.pointIcon)
                this._options.pointIcon = L.icon({ iconUrl: 'public/js/maxouMarker.png', iconSize: [16, 16], iconAnchor: [8, 8] });
            if(!options.newPointIcon)
                this._options.newPointIcon = L.icon({ iconUrl: 'public/js/maxouMarker2.png', iconSize: [16, 16], iconAnchor: [8, 8]  });
        };
